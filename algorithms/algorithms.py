...
from algorithms.discrete_quality.discrete_quality import DiscreteQualityMatcher
from algorithms.continuous_quality.continuous_quality import ContinuousQualityMatcher
from algorithms.ml_quality.ml_quality import ML_ModelQuality